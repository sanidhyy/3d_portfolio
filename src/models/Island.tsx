...
export type IslandStage = 1 | 2 | 3 | 4;

type IslandProps = ThreeElements["group"] & {
  isRotating: boolean;
  setIsRotating: Dispatch<SetStateAction<boolean>>;
  setCurrentStage: Dispatch<SetStateAction<IslandStage | null>>;
};
...
const Island = ({
  ...
  const { nodes, materials } = useGLTF(islandScene) as unknown as GLTFResult;
